...
from construct import Struct, Byte, Switch, OneOf, Array, Bytes, GreedyRange, BitStruct, \
                      BitsInteger, Flag, IfThenElse, Probe
...
from ..const import SERVICE_DATA_TYPE, MANUFACTURER_SPECIFIC_DATA_TYPE, EDDYSTONE_UUID, \
                    ...
                    CJ_MANUFACTURER_ID, FLAGS_DATA_TYPE, IBEACON_MANUFACTURER_ID, EXPOSURE_NOTIFICATION_UUID
...
ServiceData = Struct(
    "service_identifier" / OneOf(Bytes(2), [EDDYSTONE_UUID, ESTIMOTE_UUID, EXPOSURE_NOTIFICATION_UUID]),
    "service_data" / IfThenElse(lambda ctx: ctx.service_identifier == EXPOSURE_NOTIFICATION_UUID,
